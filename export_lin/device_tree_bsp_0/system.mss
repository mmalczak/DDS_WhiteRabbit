...
BEGIN OS
 ...
 PARAMETER bootargs = console=ttyPS0,115200 root=/dev/ram rw ip=:::::eth0:dhcp earlyprintk
...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = axil2wb_0
 PARAMETER compatible = xlnx,axil2wb-1.0
...
BEGIN DRIVER
 ...
 PARAMETER enet-reset = gpio0 47 0
...
BEGIN DRIVER
 ...
 PARAMETER i2c-reset = gpio0 46 0
END
